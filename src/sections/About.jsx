                    ...
                    <div className="w-full px-4 lg:w-1/2">
                        <div className="mb-12 max-w-[540px] lg:mb-0">
                            ...
                            <p className="mb-10 text-base leading-relaxed text-body-color dark:text-dark-6">
                                The main &lsquo;thrust&rsquo; is to focus on educating our clients on how to
                                best navigate the real estate market with interactive guides and
                                personalized consultations led by industry experts.
                                <br />
                                <br />
                                The main &lsquo;thrust&rsquo; is to focus on educating attendees on how to best
